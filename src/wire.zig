...
test "deserialize int" {
    ...
    try std.testing.expectError(error.InvalidData, deserializeInt(&.{ 0, 1, 2 }));
}
...
test "deserialize uint" {
    ...
    try std.testing.expectError(error.InvalidData, deserializeUint(&.{ 0, 1, 2 }));
}
...
test "deserialize array" {
    ...
    try std.testing.expectError(error.InvalidData, deserializeArray(data[0..10]));
}
...
test "deserialize string" {
    ...
    try std.testing.expectError(error.InvalidData, deserializeString(data[0..10]));
    try std.testing.expectError(error.InvalidData, deserializeString(&.{ 0, 0, 0, 0 }));
}
...
test "deserialize optional string" {
    ...
    try std.testing.expectEqualSlices(u8, data[4..][0..string.len], str.?);
    try std.testing.expectError(error.InvalidData, deserializeOptionalString(data[0..10]));
...
test "deserialize generic new id" {
    ...
    try std.testing.expectError(error.InvalidData, deserializeGenericNewId(&buf));
}
...
test "deserialize bitfield" {
    ...
    try std.testing.expectError(error.InvalidData, deserializeBitfield(TestBitfield, &.{0}));
}
...
test "deserialize enum" {
    ...
    try std.testing.expectError(error.InvalidData, deserializeEnum(TestEnum, &.{ 2, 0, 0, 0 }));
}
